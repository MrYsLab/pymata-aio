...
class RedBotAccel:
    """
    This library is a direct port of: https://github.com/sparkfun/SparkFun_RedBotAccel_Arduino_Library/tree/V_1.1.0
    ...
    def check_who_am_i(self):
        ...
        """
        register = self.RedBotAccel_Register['WHO_AM_I']
    ...
    def standby(self):
        ...
        @return: No return value
        """
        register = self.RedBotAccel_Register['CTRL_REG1']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def set_scale(self, scale):
        ...
        @return: No return value
        """
        register = self.RedBotAccel_Register['XYZ_DATA_CFG']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def setup_portrait_landscape(self):
        ...
        @return: No return value
        """
        register = self.RedBotAccel_Register['PL_CFG']
        ...
        register = self.RedBotAccel_Register['PL_COUNT']
    ...
    def read_portrait_landscape(self):
        """
        This function reads the portrait/landscape status register of the RedBotAccel.
        ...
        @return: See above.
        """
        register = self.RedBotAccel_Register['PL_STATUS']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def setup_tap(self, x_ths, y_ths, z_ths):
        ...
        register = self.RedBotAccel_Register['PULSE_CFG']
        ...
        register = self.RedBotAccel_Register['PULSE_TMLT']
        ...
        register = self.RedBotAccel_Register['PULSE_LTCY']
        ...
        register = self.RedBotAccel_Register['PULSE_WIND']
        self.board.i2c_write_request(self.address, [register, 0xFF])  # 5. 318ms (max value) between taps max

    def read_tap(self):
        """
        This function returns any taps read by the RedBotAccel. If the function
        ...
        """
        register = self.RedBotAccel_Register['PULSE_SRC']
    ...
    def available(self):
        ...
        """
        register = self.RedBotAccel_Register['STATUS']
        self.board.i2c_read_request(self.address, register, 1, Constants.I2C_READ | Constants.I2C_END_TX_MASK,
                                    self.data_val)
    ...
    def read(self):
        ...
        """
        register = self.RedBotAccel_Register['OUT_X_MSB']
