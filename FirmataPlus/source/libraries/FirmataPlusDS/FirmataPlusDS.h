...
#ifndef Firmata_Plus_DS_h
#define Firmata_Plus_DS_h
...
// onewire subcommands
#define DS_DISCOVER_DEVICES      0x40 // find all of the one wire devices
#define DS_DISCOVERY_REPLY       0x41 // a discovery reply message
#define DS_REQUEST_TEMPERATURE   0x42
#define DS_TEMPERATURE_REPLY     0x43
